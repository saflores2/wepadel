...
user2 = User.create!(name: "Enrique", last_name:"Noriega ", email: "Enrique@gmail.com", password: "123456", phone: "911223344")
...
user4 = User.create!(name: "Pedro", last_name:"Méndez", email: "PedroMendez@gmail.com", password: "123456", phone: "911223344")
...
user5 = User.create!(name: "Luisa", last_name:"Hernández", email: "LuisaHernandez@gmail.com", password: "123456", phone: "911223344")
...
user6 = User.create!(name: "Juan", last_name:"Pérez", email: "JuanPerez@gmail.com", password: "123456", phone: "911223344")
archivo6 = URI.open("https://images.pexels.com/photos/1681010/pexels-photo-1681010.jpeg")
user6.photo.attach(io: archivo6, filename: "juan.png", content_type: "image/png")
user6.save
puts "#{user6.name} creado exitosamente"

user7 = User.create!(name: "Miguel", last_name:"González", email: "miguel.gonzalez@gmail.com", password: "123456", phone: "911223344")
...
user8 = User.create!(name: "Laura", last_name:"López", email: "laura.lopez@gmail.com", password: "123456", phone: "911223344")
archivo8 = URI.open("https://images.pexels.com/photos/8485104/pexels-photo-8485104.jpeg")
...
user10 = User.create!(name: "Julia", last_name:"Fernández", email: "Julia@gmail.com", password: "123456", phone: "911223344")
...
user11 = User.create!(name: "Fabian", last_name: "Rubio", email: "fabian@gmail.com", password: "123456", phone: "911223344")
...
user12 = User.create!(name: "Steve", last_name: "Brusa", email: "steve@gmail.com", password: "123456", phone: "911223344")
...
user13 = User.create!(name: "Fernando", last_name: "Gonzalez", email: "fernando@gmail.com", password: "123456", phone: "911223344")
file = URI.open("https://avatars.githubusercontent.com/u/108149366?v=4")
user13.photo.attach(io: file, filename: "fdo.png", content_type: "image/png")
user13.save
puts "#{user13.name} created successfully"

user14 = User.create!(name: "Claudio", last_name: "Vergara", email: "claudio@gmail.com", password: "123456", phone: "911223344")
file = URI.open("https://avatars.githubusercontent.com/u/108149366?v=4")
user14.photo.attach(io: file, filename: "fdo.png", content_type: "image/png")
user14.save
puts "#{user14.name} created successfully"

user15 = User.create!(name: "Nicolas", last_name: "Massu", email: "nicolas@gmail.com", password: "123456", phone: "911223344")
file = URI.open("https://avatars.githubusercontent.com/u/108149366?v=4")
user15.photo.attach(io: file, filename: "fdo.png", content_type: "image/png")
user15.save
puts "#{user15.name} created successfully"

user16 = User.create!(name: "Jorge", last_name: "Gonzalez", email: "jorge@gmail.com", password: "123456", phone: "911223344")
file = URI.open("https://avatars.githubusercontent.com/u/108149366?v=4")
user16.photo.attach(io: file, filename: "fdo.png", content_type: "image/png")
user16.save
puts "#{user16.name} created successfully"

user17 = User.create!(name: "Julian", last_name: "Alvarez", email: "julian@gmail.com", password: "123456", phone: "911223344")
file = URI.open("https://avatars.githubusercontent.com/u/108149366?v=4")
...
user19 = User.create!(name: "Tomas", last_name: "Valdivia", email: "tomas@gmail.com", password: "123456", phone: "911223344")
file = URI.open("https://avatars.githubusercontent.com/u/108149366?v=4")
...
tournament1 = Tournament.create!(name: "Champions League", ubication_name: "Club Red-Padel", ubication_address: "Av Vitacura 8751", user_id: user1.id, price: 10000, start_date: 2023-03-24, end_date: 2023-03-26, duration: 3, type: "Champions League", gender: "Mixto", min_matches: 3, max_matches: 5, places: 16, match_duration: 1, awards: "Trofeo y Medalla", other: "Inscripcion Hasta el 22 de Marzo")
...
tournament3 = Tournament.create!(name: "Express", ubication_name: "Pasco Club", ubication_address: "El Aguilucho 3308", user_id: user3.id, price: 8000, start_date: 2023-04-07, end_date: 2023-04-07, duration: 1, type: "Express", gender: "Mixto", min_matches: 3, max_matches: 3, places: 4, match_duration: 1, awards: "Trofeo", other: "Inscripcion Hasta el 05 de Abril")
